...
`masslegalhelp/snap-abawd/index.html` is the screener. It is what reviewers look at and what
...
`masslegalhelp/index.html`. Read `masslegalhelp/README.md` before touching any of it; it
