...
const HTML = path.join(ROOT, 'masslegalhelp', 'tools', 'snap-abawd', 'index.html');
...
w('(`masslegalhelp/tools/snap-abawd/index.html`) and the shared decision logic. If a string is on the page,');
