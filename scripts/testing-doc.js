...
blank();
check('The start page loads and shows the heading, the intro text, and the age question.');
check('The "Fill out the form" button does nothing until the age question is answered.');
check('Answering **No** to the age question and continuing goes straight to the age result, skipping every other question.');
check('Answering **Yes** starts the questions.');
...
w('answer is right.');
blank();
check('**Age beats everything.** Answer No to the age question and Yes to a clear exemption. Expect the age result, not the exempt result.');
...
check('Turn on the operating system\'s "reduce motion" setting. Screens change without animation.');
